...
public class DTO_Plante {
    ...
    public DTO_Plante(int id_plante, String nom, int degat_attaque, int cout, int point_de_vie,
                      double attaque_par_seconde, double soleil_par_seconde,
                      String chemin_image, String effet) {
