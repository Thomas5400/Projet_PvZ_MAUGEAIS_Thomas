...
public class Zombie {
    ...
    public Zombie(int id_zombie, int point_de_vie, String nom, double vitesse_de_deplacement, double attaque_par_seconde, int degat_attaque, String chemin_image, int id_map) {
    ...
    // Getters et setter des attributs de la classe zombie
